...
public class DataServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    for (Entity entity : results.asIterable()) {
      ...
      Comment comment = new Comment(sender, message, email, imageUrl, score);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    String tempSubject = request.getParameter("subject");
     ...
     // Sentiment sentiment = languageService.analyzeSentiment(doc).getDocumentSentiment();
      ...
      Entity commentEntity = new Entity("Chat");
  ...
  public void addNewComment(HttpServletRequest request, UserService userService) throws IOException{
      String tempSubject = request.getParameter("subject");
      String commentText = request.getParameter("text");
      String email = userService.getCurrentUser().getEmail();
      String imageUrl = getUploadedFileUrl(request, "image");
